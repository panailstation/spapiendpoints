...
const createFeedDocument = async () => {
    try {
        ...
        const response = await axios.post(`${endpoint}/feeds/2021-06-30/documents`, {
...
const uploadFeed = async (feedUrl) => {
    ...
    instance.post(feedUrl, exampleFeedDocument)
        .then(response => {
...
const createShipment = async (req, res) => {
    try {
        ...
        await axios.post(url, {
            ...
            .catch(error => {
                res.status(500).json({ message: "Error cancelling shipment", error: error.response.data });
            });
    } catch (error) {
...
const getShipment = async (req, res) => {
    ...
    try {
        ...
        await axios.get(`${endpoint}/shipping/v1/shipments/${shipmentId}`, {
            "headers": {
                "x-amz-access-token": authTokens.access_token,
            }
        }).then(response => {
...
const cancelShipment = async (req, res) => {
    ...
    try {
        ...
        await axios.post(`${endpoint}/shipping/v1/shipments/${shipmentId}/cancel`, {}, { headers: headers })
            .then(response => {
                return res.status(200).json(response.data);
            })
            .catch(error => {
        ...
        res.status(500).json({ message: "Error cancelling shipment", error: error });
    }
};
...
const purchaseLabel = async (req, res) => {
    ...
    try {
        ...
        await axios.post(`${endpoint}/shipping/v1/shipments/${shipmentId}/purchaseLabels`, {
...
const createFeed = async (req, res) => {
    try {
        ...
        axios.post(`${endpoint}/feeds/2021-06-30/feeds`, {
            ...
            axios.get(`${endpoint}/feeds/2021-06-30/feeds/${response.data.feedId}`, {
                "headers": {
                    "Content-Type": "application/json",
                    "x-amz-access-token": authTokens.access_token,
                }
